...
void constructor_with_no_elements() {
  stl::_vector<T> stl_vector(my::Allocator<T>);
...
void constructor_with_value(int count,const T value) {
  ...
  {
    stl::_vector<T, my::Allocator<T>> stl_vector(count, value);
    my::vector_<T, my::Allocator<T>> my_vector(count, value);
    compare_vector<T, my::Allocator<T>>(my_vector, stl_vector);
  }
}
...
//  try {
//    stl::_vector<int> my_vector(10, 1);
...
//    stl::_vector<T> stl_vector(20000, value);
//    my::vector_<T> my_vector(20000, value);
//    stl_vector.emplace(stl_vector.end(), std::forward<Args>(args) ...);
...
//  // all self
//  {
//    stl_vector.insert(stl_vector.begin(), stl_vector.begin(), stl_vector.begin());
...
//  // capacity >= count
//  {
//    stl::_vector<T> stl_vector(20000);
//    my::vector_<T> my_vector(20000);
//    insert_range_test<T>(my_vector, stl_vector, value);
//  }
//}
//
